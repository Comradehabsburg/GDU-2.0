...
NDiplomacy = {
	...
	HRE_HERETIC_PENALTY = -0.0025,					-- Per heretic prince (halved by Peace of Westphalia)
	...
	AE_OTHER_CONTINENT = 12.5,
	AE_SAME_CULTURE = 0.75,
	AE_SAME_CULTURE_GROUP = 0.31,
	AE_INFIDEL_CONQUEST = 0.31, 		-- different religion group conquered same religion province
