...
NDiplomacy = {
	...
	BASE_SEND_ATTACHE_COST = 75,					-- Political power cost to send attache(from gdu)(vanilla 100)
	BASE_SEND_ATTACHE_CP_COST = 0.0,				-- Command Power sent attache usage cost(from gdu)(vanilla 50.0)
...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0               --Removed for game stability/reducing chance of desync(from gdu)
...
NMilitary = {
	...
	DEPLOY_TRAINING_MAX_LEVEL = 2,				`	-- vanilla 1, you can train to trained in deployment queue(from gdu)
	TRAINING_EXPERIENCE_SCALE = 156.0,              -- vanilla 62.0  how fast you train in deployment queue
	TRAINING_ORG = 0.2,
	ARMY_EXP_BASE_LEVEL = 1,
	UNIT_EXP_LEVELS = { 0.2, 0.3, 0.4, 0.5 },		-- Experience needed to progress to the next level
	...
	TRAINING_MAX_DAILY_COUNTRY_EXP = 0.24,			-- Maximum army XP gained per day from training
