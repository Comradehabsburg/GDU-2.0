...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.20        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
...
NDefines.NMilitary.EQUIPMENT_COMBAT_LOSS_FACTOR = 1	 	   -- % of equipment lost to strength ratio in combat so some % is returned if below 1
